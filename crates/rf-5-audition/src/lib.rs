...
fn scenes() -> Vec<Scene> {
    vec![
        ...
        Scene {
            ...
            description: "Slow end of the absolute SD334/CEM3340 common-LFO frequency law",
            scale_codes: EQUAL_TEMPERAMENT,
        ...
        Scene {
            ...
            description: "V8.1 stored RELEASE bit overrides both deliberately maximum release pots with fixed CV 0x64, equivalent to pot code 0x16",
            scale_codes: EQUAL_TEMPERAMENT,
        ...
        Scene {
            id: "30_filter_slew_transient",
            program: "audition-filter-slew-transient",
            description: "Fast high-drive sweeps exercise the stateful TL082 slew boundary inside each resonance loop",
            scale_codes: EQUAL_TEMPERAMENT,
            events: chord_sequence(&[
                (0.20, 0.78, &[36, 43, 48]),
                (1.02, 1.60, &[48, 55, 60]),
        ...
        Scene {
            id: "31_envelope_phase_steps",
            program: "audition-envelope-phase-steps",
            description: "Repeated gates expose the CEM3310 buffer-resistance steps at attack, decay and release transitions",
            scale_codes: EQUAL_TEMPERAMENT,
            events: chord_sequence(&[
                (0.20, 0.72, &[36]),
                (0.96, 1.48, &[43]),
        ...
        Scene {
            id: "32_lfo_saw_unipolar",
            program: "audition-lfo-saw-unipolar",
            description: "Positive-going CEM3340 saw reaches Wheel Mod directly through its switched 160k path",
            scale_codes: EQUAL_TEMPERAMENT,
            events: chord_sequence(&[(0.20, 5.20, &[45, 52, 57])]),
        },
        Scene {
            id: "33_lfo_square_unipolar",
            program: "audition-lfo-square-unipolar",
            description: "Loaded positive-going CEM3340 square reaches Wheel Mod through its switched 200k path",
            scale_codes: EQUAL_TEMPERAMENT,
            events: chord_sequence(&[(0.20, 5.20, &[45, 52, 57])]),
        },
        Scene {
