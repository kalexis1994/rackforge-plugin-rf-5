...
| --- | --- | --- | --- | --- |
| SRC-001 | Sequential, original *Prophet-5 Owner's Manual* ([archival scan](https://device.report/m/53bd1bb5dfcacc44b25c01ad486bc93a9adc1fdfc4fdb0340c51b239ee1c578d_pdf)) | Public control architecture, performance behaviour, approximate 1ms-30s envelope range and 0.5s position-5 landmark, non-programmable MASTER TUNE classification, oscillator-B FINE direction/span, 1-99% pulse-width range and modulation overtravel, pitch-wheel span, Poly Mod routing and Scale Mode operation | Manufacturer documentation | Accepted for topology, the global envelope panel calibration, MASTER TUNE's machine-state boundary, B FINE's zero-to-one-semitone law, panel pulse-width endpoints and DC degeneration under modulation, approximately +/-one-fifth pitch-wheel span and twelve-note Scale Mode operator behavior; SHA-256 `4C5D84BBB5A0FE8D1687A66DB67292259BFF160D7738F0366DB8DE39026FB85C` |
...
| SRC-003 | Sequential, *Original Prophet-5 Factory Program Patch Sheets* ([manufacturer PDF](https://sequential.com/wp-content/uploads/2020/10/Original-Prophet-5-Patch-Sheets-1.1.pdf)) | Original forty-program names, addresses, control routes and written performance notes | Manufacturer document | Accepted as independent validation of the digital Group 5 projection; no knob value is estimated from the scans. Program 1-4 explicitly identifies its decaying octave overtone and recommends RELEASE off plus the footswitch for piano-pedal articulation; SHA-256 `21A2295BC6D583109AD63DE5CA33C85F2B530A99741C71DDDF056EB6B33A7973` |
| SRC-004 | Sequential Circuits, *Prophet-5 Synthesizer Technical Manual*, TM1000D.2, Oct. 1981 ([archival scan](https://www.synfo.nl/servicemanuals/Sequential/SEQUENTIAL_PROPHET-5_REV3_SERVICE_MANUAL.pdf)) | Rev 3.0-3.2 topology, schematics, calibration, control scanning, position-6 approximately-one-second envelope tests and position-10 greater-than-20-second release tests, MASTER TUNE/master-summer path, pitch-wheel deadband, complete SD334 LFO timing/reference/scale and waveform routing including positive-going saw/pulse versus U380-level-shifted triangle, SD431's CEM3340 pulse pull-down/mixer switching, one-edge U446/C4107/R4296/R4297/Q401 conventional hard-sync network and complete CEM3320 resonance-return population, plus selected IC data sheets | Manufacturer technical manual | Accepted; SHA-256 `6B8701C4F526AB415CBA8BE2CA5538BDE14B228A0948151EBA964DA06A97BD25` |
...
| SRC-010 | Curtis Electromusic, *CEM3340/3345 Voltage Controlled Oscillator* ([original data sheet scan](https://electricdruid.net/wp-content/uploads/2020/02/CEM33403345-VCO.pdf)) | Temperature compensation, oscillator drift limits, exact multiplier/exponential/frequency equations, 400/570/800uA timing-current limits, exponential-scale error, 0-5 V PWM control law, waveform/output behaviour, loaded pulse-high equation and triangle-buffer load-dependent frequency pull | Manufacturer data sheet | Accepted, including the absolute LFO law reconstructed with SD334's populated network, the published pulse-output 0.6 mA breakpoint/1.3 kohm slope, 65-150 ohm triangle-output-impedance range and `Rout / Rload` triangle-frequency reduction; SHA-256 `9D23F54FE97114C45BCE7B1B74BABE7FF4EC05AFF6CF5D17206C1EE6649EC82A` |
...
| SRC-015 | Texas Instruments, *NE5534x/SA5534x Low-Noise Operational Amplifiers*, SLOS070D, July 1979, rev. Nov. 2014 ([manufacturer data sheet](https://www.ti.com/lit/ds/symlink/ne5534.pdf)) | SD430 U481 follower output swing, current capability, slew rate and output impedance under the populated +/-15 V supply and 1 kohm board load | Manufacturer data sheet | Accepted for 24 Vpp guaranteed/26 Vpp typical swing into at least 600 ohm, 38 mA typical output current, 13 V/us typical slew and 0.3 ohm typical closed-loop output impedance; exact historical device spread and external jack load remain unmeasured |
| SRC-016 | Sequential, `Prophet-510-Factory-Programs-ReadMe1.02.zip` ([manufacturer download](https://sequential.com/wp-content/uploads/2020/11/Prophet-510-Factory-Programs-ReadMe1.02.zip)) | Official 200-program SysEx whose Group 5 contains the original forty programs | Manufacturer digital data | Accepted for exact legacy pot codes and switches after deterministic projection to the V8.1 24-byte record; ZIP SHA-256 `6EE129B4ED2422B7B9758ED270A6934DCBA3CFDAA18F02E9E10596139F2B3261`, SysEx SHA-256 `0050B8ED0021CB21262E96B0513068C5D36524E04DC45A1095BB73CCAF3FC8F1` |
| SRC-017 | Sequential, *Prophet-5 MIDI Implementation 1.4* ([manufacturer PDF](https://www.sequential.com/wp-content/uploads/2021/03/Prophet-5-MIDI-Implementation-1.4.pdf)) | Program-message framing, packed-MSB expansion and NRPN byte order | Manufacturer technical document | Accepted for decoding the official SysEx; SHA-256 `5B86F304689A958A3CDD7F2E53A7C4C12BE05DA6EDF09FB7597A794630DD219A` |
| SRC-018 | Synthmania, *Prophet-5 Rev.3 - File 1 Factory Programs* ([hardware demo page](https://www.synthmania.com/Prophet-5%20%28Rev.3%29.htm)) | Perceptual reference recordings from a Rev 3.2 instrument upgraded to 3.3; 1-1 Brass common-vibrato rate, 1-4 Electric Piano octave attack and fast envelope region, 1-7 Sync I attack trajectory and 2-4 Toy Piano held-key decay | Third-party hardware recording | Accepted only as a bounded auditory cross-check, not as a general electrical measurement. The 1-1 Brass recording's shared pitch motion is approximately 5.29 Hz, consistent with Sequential's documented approximately-5-Hz factory intent and the corrected 4.34 Hz nominal SD334 result. The first isolated 1-4 note places its fundamental and octave bands within about 0.1 dB and, together with Sequential's explicit RELEASE-off performance instruction, bounds useful rise to approximately 3-5 ms and the fast cutoff to approximately 5 ms. This constrains only exact Attack code 30 and firmware RELEASE-off code 22, not the programmed RELEASE-on law. Sync I confirms a descending guitar-like hard-sync attack rather than a bus-pinned sustained upper harmonic and led back to SD333's independently visible five-way IABC fanout; it does not set an arbitrary patch correction. Toy Piano is accepted only for its held-key decay/performance interpretation because its unknown gate durations cannot identify the programmed Release law; local MP3 SHA-256 values: Brass `619322A767E875BA1EC81B54E42A8B8A5FD5695BF438BC1F67DD088D60C4A431`, Electric Piano `3021280C496C2DF3F8DBE75A1450E70993095ABF2F193C5A941A86765BC2F8C1`, Sync I `A783B152FD028E42E2D689A03FB9166D0D72AC2E64D82FC4798B98830B93E02E`, Toy Piano `8297FD40223EB6EFE46992577DA4AAB66F71FB840D19C0531253346442F9DB19` |
| SRC-019 | Synthmania, *2-1 Unison Glide With Resonance* from the same Rev 3.2 hardware demo | Bounded spectral cross-check for a factory program combining dual saws, Unison, Glide, keyboard tracking and substantial resonance | Third-party hardware recording | Accepted only to discriminate internal-rate candidates while preserving the official program bytes. On the first stable approximately-B2 region, the former host-rate path placed the 3-8 kHz band about 6.2 dB below the complete four-times oracle. The four-times-oscillator/held-two-times-filter candidate matches all five broad oracle bands within 0.03 dB and restores the hardware recording's audible upper saw/resonance content without program-specific EQ; local MP3 SHA-256 `4D9A5CE9428035F4C70EF8FD5FC7074E9245DB45D6F6316A42A2DE1CB43FA76F` |
| SRC-020 | Synthchaser, *Sequential Circuits Prophet 5 Factory Patches Demo* ([Rev. 3.2 hardware video](https://www.youtube.com/watch?v=7AiRi7cGS3g)) | Independent factory-program performance, including 2-1 Unison Glide With Resonance | Third-party hardware recording | Accepted only as a second bounded auditory cross-check. Its 2-1 performance independently preserves a finer periodic saw edge than the former wide-PolyBLEP candidate; it does not authorize edits to the official program bytes or identify a populated transfer function. RF-5 responds at the source boundary with a narrower alias-bounded saw reset while preserving the independently verified static-pulse tables; local AAC stream SHA-256 `B66B7CF47D189ACBEAA7D95D412EC249332AD2145A42965CDCB9B942BEBF79EB` |
...
sequencer output. This ordering remains an internal firmware fact; host MIDI
is admitted after the assigned voice's first pitch/filter pass because the
keyboard matrix cannot be observed halfway through that private operation and
the corresponding stale-pitch burst is absent from the hardware recordings.
Offsets `0x0336-0x0358`, `0x04D1-0x04F6` and
...
branch, its normal `0x7a - pot` time transform and fixed `0x64` disabled value;
the shared path makes the latter exactly equivalent to pot code `0x16`. SD333 independently fixes the
